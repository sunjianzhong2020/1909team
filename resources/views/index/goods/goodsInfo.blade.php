            ...
            <div class="fl preview-wrap">
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
                        <span class="jqzoom"><img jqimg="{{$goods_info->goods_img}}" src="{{$goods_info->goods_img}}"  style="width:400px;height:400px"/></span>
                    </div>
                    <!--下方的缩略图-->
            ...
            <div class="fr itemInfo-wrap">
                ...
                <div class="summary">
                    <div class="summary-wrap">
                        ...
                        <div class="fr remark">
                            <i>累计评价</i><em>{{$goods_info->goods_price}}</em>
                        </div>
                    </div>
                    <div class="summary-wrap">
                        <div class="fl title">
                ...
                <div class="clearfix choose">
                    <div id="specification" class="summary-wrap clearfix">
                        <dl>
                            ...
                            <dd><a href="javascript:;" class="selected">{{$goods_info->sku_val_name}}<span title="点击取消选择">&nbsp;</span>
                                </a></dd>
                ...
                <div class="clearfix fitting">
                    ...
                    <div class="good-suits">
                        <div class="fl master">
                            <div class="list-wrap">
                                <div class="p-img">
                                    <img src="{{$goods_info->goods_img}}"   style="width:107px;height:128px"/>
                                </div>
                                <em>￥5299</em>
                                <i>+</i>
                            </div>
                        ...
                        <div class="fl suits">
                            <ul class="suit-list">
                                <li class="">
                                    <div id="">
                                        <img src="{{$goods_info->goods_img}}"   style="width:109px;height:124px"/>
                                    </div>
                                    <i>Feless费勒斯VR</i>
                                ...
                                <li class="">
                                    <div id=""><img src="{{$goods_info->goods_img}}"  style="width:107px;height:128px"/> </div>
                                    <i>Feless费勒斯VR</i>
                                    <label data-toggle="checkbox" class="checkbox-pretty">
                    ...
                    <div class="tab-content tab-wraped">
                        <div id="one" class="tab-pane active">
                            ...
                            <div class="intro-detail">
                                <img src="{{$goods_info->goods_img}}" style="width:960px;height:775px" />
                                <img src="{{$goods_info->goods_img}}"   style="width:960px;height:775px" />
                                <img src="{{$goods_info->goods_img}}"   style="width:960px;height:775px" />
                            </div>
                        </div>
...
<script type="text/javascript" src="/index/index/index.js"></script>
</body>
