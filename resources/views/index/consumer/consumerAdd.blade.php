...
<head>
    ...
    <title>设置-个人信息</title>
    <link rel="icon" href="/index/img/assets/img/favicon.ico">
                        ...
                        <div id="one" class="tab-pane active">
                            <form id="form-msg" class="sui-form form-horizontal">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="inputName" name="con_name" placeholder="昵称">
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <label data-toggle="radio" class="radio-pretty inline">
                                            <input type="radio" name="con_sex" value="1" checked><span>男</span>
                                        </label>
                                        <label data-toggle="radio" class="radio-pretty inline">
                                            <input type="radio" name="con_sex" value="2"><span>女</span>
                                        </label>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select id="select_year2" rel="1990" name="con_year"></select>年
                                        <select id="select_month2" rel="4" name="con_month"></select>月
                                        <select id="select_day2" rel="3" name="con_day"></select>日
                                    </div>
                                </div>
                                    ...
                                    <div class="controls">
                                        <div data-toggle="distpicker">
                                            <div class="form-group area">
                                                <select class="form-control" id="province1" name="con_country"></select>
                                            </div>
                                            <div class="form-group area">
                                                <select class="form-control" id="city1" name="con_city"></select>
                                            </div>
                                            <div class="form-group area">
                                                <select class="form-control" id="district1" name="con_area"></select>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
{{--                                                <input name="job" type="hidden" data-rules="required"><i class="caret"></i><span>请选择</span></a>--}}
                                            <select id="menu4" role="menu" name="w_id" aria-labelledby="drop4" class="sui-dropdown-menu">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <button type="button" class="sui-btn btn-primary" name="btn">立即注册</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
<script>
    $(document).ready(function(){
         $("button[name='btn']").click(function(){
             ...
             data.con_sex =  $("input[name='con_sex']:checked").val();
             data.con_year =  $("select[name='con_year']").val();
             data.con_month =  $("select[name='con_month']").val();
             data.con_day =  $("select[name='con_day']").val();
             data.con_country =  $("select[name='con_country']").val();
             data.con_city =  $("select[name='con_city']").val();
             data.con_area =  $("select[name='con_area']").val();
             data.w_id =  $("select[name='w_id']").val();

             // alert(data.w_id);

             // return false;
             var url = '/index/consumerAdd_do';
             $.ajax({
                 url:url,
                 data:data,
                 type:"post",
                 ...
                 success:function(res){
                     if(res.code==200){
                         alert(res.message);
                         window.location.href = '/index/consumerAdd';
                     }else{
                         alert(res.message);
                         window.location.href = '/index/consumerAdd';
                     }
