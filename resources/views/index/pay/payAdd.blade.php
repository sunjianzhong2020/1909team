...
<div class="cart py-container">
    ...
    <div class="checkout py-container">
        ...
        <div class="checkout-steps">
            <!--收件人信息-->
            <div class="step-tit">
                <h5>收件人信息<span><a href="{{url('index/address')}}" data-keyboard="false">新增收货地址</a></span></h5>
            </div>
            <div class="step-cont">
                <div class="addressInfo">
                    <ul class="addr-detail">
                        <li class="addr-item">
                            ...
                            <div>
                                    @if($v->status==1)
                                <div class="con name selected"><a href="javascript:;" >{{$v->shop_address_name}}<span title="点击取消选择">&nbsp;</a></div>
                                    @else
                                    <div class="con name "><a href="javascript:;" >{{$v->shop_address_name}}<span title="点击取消选择">&nbsp;</a></div>
                                @endif
                                    <div class="con address">{{$v->shop_address_name}}&nbsp;&nbsp;{{$v->shop_address_province}}{{$v->shop_address_city}}{{$v->shop_address_area}}<span>&nbsp;&nbsp;159****3201</span>
                                    <span class="base">
                                        {{$v->status==1 ? "默认地址" : "收货地址"}}
                                    </span>
                               ...
                               @foreach($goods_info as $v)
                                <ul class="yui3-g">
                                    ...
                                    <li class="yui3-u-1-12">
                                        <div class="price">￥{{$v->total_price}}</div>
                                    </li>
                                    <li class="yui3-u-1-12">
    ...
    <input type="hidden" class="goodss_id" value="{{$goodss_id}}">
    <div class="order-summary">
        <div class="static fr">
            <div class="list">
                @php $count=count($goods_info); @endphp
                <span><i class="number">{{$count}}</i>件商品，总商品金额</span>
                <em class="allprice">¥{{$money}}</em>
            </div>
            <div class="list">
                <span>返现：</span>
    ...
    <div class="submit">
        <a class="sui-btn btn-danger btn-xlarge addMoney" href="javascript:;">提交订单</a>
    </div>
</div>
<!-- 底部栏位 -->
<!--页面底部-->
...
<script type="text/javascript" src="/index/components/ui-modules/nav/nav-portal-top.js"></script>
