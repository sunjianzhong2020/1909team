...
<div class="box-header with-border">
    <h3 class="box-title">广告分类添加管理</h3>
</div>
    ...
    <div class="table-box">
        ...
        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
            ...
            <tr>
                ...
                <td><input type="text" name="shop_ment_cate_name" id="shop_ment_cate_name" placeholder="请输入广告类型...">
                    <button class="btn btn-primary" id="btn" type="button">添加</button>
                </td>
            </tr>
            </tbody>
        </table>
...
<script>
    $(document).on('click','#btn',function(){
        ...
        //alert(shop_ment_cate_name);false;
        ...
        $.ajax({
            url:"/ment/cateadddo",
            data:{'shop_ment_cate_name':shop_ment_cate_name},
            type:"post",
            dataType:'json',
